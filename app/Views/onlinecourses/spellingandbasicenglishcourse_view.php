        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center">
                    <h2 class= "pt-2 pb-2 text-white">Online Courses</h2>
                    <div class="">
                        <nav aria-label="breadcrumb" >
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>">Online Courses</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Spelling and Basic English Course</li>
                            </ol>
                        </nav>
                    </div>
                </div>
